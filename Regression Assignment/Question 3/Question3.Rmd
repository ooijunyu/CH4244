...
We can see that PCR does not perform as well compared to the linear regression with transformed variable with that significantly smaller $R^2_{adj}$ value.
